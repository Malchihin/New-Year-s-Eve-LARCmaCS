...
class GameEvent_AttackerInDefenseArea;
class GameEvent_AttackerInDefenseAreaDefaultTypeInternal;
extern GameEvent_AttackerInDefenseAreaDefaultTypeInternal _GameEvent_AttackerInDefenseArea_default_instance_;
...
class GameEvent_AttackerTouchedKeeper;
class GameEvent_AttackerTouchedKeeperDefaultTypeInternal;
extern GameEvent_AttackerTouchedKeeperDefaultTypeInternal _GameEvent_AttackerTouchedKeeper_default_instance_;
...
template<> ::GameEvent_AttackerInDefenseArea* Arena::CreateMaybeMessage<::GameEvent_AttackerInDefenseArea>(Arena*);
template<> ::GameEvent_AttackerTooCloseToDefenseArea* Arena::CreateMaybeMessage<::GameEvent_AttackerTooCloseToDefenseArea>(Arena*);
template<> ::GameEvent_AttackerTouchedKeeper* Arena::CreateMaybeMessage<::GameEvent_AttackerTouchedKeeper>(Arena*);
...
constexpr GameEventType GameEventType_MAX = POSSIBLE_GOAL;
...
class GameEvent_AttackerInDefenseArea PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:GameEvent.AttackerInDefenseArea) */ {
 public:
  inline GameEvent_AttackerInDefenseArea() : GameEvent_AttackerInDefenseArea(nullptr) {};
  virtual ~GameEvent_AttackerInDefenseArea();

  GameEvent_AttackerInDefenseArea(const GameEvent_AttackerInDefenseArea& from);
  GameEvent_AttackerInDefenseArea(GameEvent_AttackerInDefenseArea&& from) noexcept
    : GameEvent_AttackerInDefenseArea() {
    *this = ::std::move(from);
  }

  inline GameEvent_AttackerInDefenseArea& operator=(const GameEvent_AttackerInDefenseArea& from) {
    CopyFrom(from);
    return *this;
  }
  inline GameEvent_AttackerInDefenseArea& operator=(GameEvent_AttackerInDefenseArea&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GameEvent_AttackerInDefenseArea& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GameEvent_AttackerInDefenseArea* internal_default_instance() {
    return reinterpret_cast<const GameEvent_AttackerInDefenseArea*>(
               &_GameEvent_AttackerInDefenseArea_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    13;

  friend void swap(GameEvent_AttackerInDefenseArea& a, GameEvent_AttackerInDefenseArea& b) {
    a.Swap(&b);
  }
  inline void Swap(GameEvent_AttackerInDefenseArea* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(GameEvent_AttackerInDefenseArea* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline GameEvent_AttackerInDefenseArea* New() const final {
    return CreateMaybeMessage<GameEvent_AttackerInDefenseArea>(nullptr);
  }

  GameEvent_AttackerInDefenseArea* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GameEvent_AttackerInDefenseArea>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GameEvent_AttackerInDefenseArea& from);
  void MergeFrom(const GameEvent_AttackerInDefenseArea& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GameEvent_AttackerInDefenseArea* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "GameEvent.AttackerInDefenseArea";
  }
  protected:
  explicit GameEvent_AttackerInDefenseArea(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
class GameEvent_AttackerTouchedKeeper PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:GameEvent.AttackerTouchedKeeper) */ {
 public:
  inline GameEvent_AttackerTouchedKeeper() : GameEvent_AttackerTouchedKeeper(nullptr) {};
  virtual ~GameEvent_AttackerTouchedKeeper();

  GameEvent_AttackerTouchedKeeper(const GameEvent_AttackerTouchedKeeper& from);
  GameEvent_AttackerTouchedKeeper(GameEvent_AttackerTouchedKeeper&& from) noexcept
    : GameEvent_AttackerTouchedKeeper() {
    *this = ::std::move(from);
  }

  inline GameEvent_AttackerTouchedKeeper& operator=(const GameEvent_AttackerTouchedKeeper& from) {
    CopyFrom(from);
    return *this;
  }
  inline GameEvent_AttackerTouchedKeeper& operator=(GameEvent_AttackerTouchedKeeper&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GameEvent_AttackerTouchedKeeper& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GameEvent_AttackerTouchedKeeper* internal_default_instance() {
    return reinterpret_cast<const GameEvent_AttackerTouchedKeeper*>(
               &_GameEvent_AttackerTouchedKeeper_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    16;

  friend void swap(GameEvent_AttackerTouchedKeeper& a, GameEvent_AttackerTouchedKeeper& b) {
    a.Swap(&b);
  }
  inline void Swap(GameEvent_AttackerTouchedKeeper* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(GameEvent_AttackerTouchedKeeper* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline GameEvent_AttackerTouchedKeeper* New() const final {
    return CreateMaybeMessage<GameEvent_AttackerTouchedKeeper>(nullptr);
  }

  GameEvent_AttackerTouchedKeeper* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GameEvent_AttackerTouchedKeeper>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GameEvent_AttackerTouchedKeeper& from);
  void MergeFrom(const GameEvent_AttackerTouchedKeeper& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GameEvent_AttackerTouchedKeeper* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "GameEvent.AttackerTouchedKeeper";
  }
  protected:
  explicit GameEvent_AttackerTouchedKeeper(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
class GameEvent PROTOBUF_FINAL :
 ...
 public:
  ...
  enum EventCase {
    ...
    kAttackerInDefenseArea = 15,
    kAttackerTouchedKeeper = 16,
  ...
  typedef GameEvent_AttackerInDefenseArea AttackerInDefenseArea;
  typedef GameEvent_BotKickedBallTooFast BotKickedBallTooFast;
  typedef GameEvent_BotDribbledBallTooFar BotDribbledBallTooFar;
  typedef GameEvent_AttackerTouchedKeeper AttackerTouchedKeeper;
  ...
  enum : int {
    ...
    kAttackerInDefenseAreaFieldNumber = 15,
    kAttackerTouchedKeeperFieldNumber = 16,
  ...
  bool has_attacker_in_defense_area() const;
  private:
  bool _internal_has_attacker_in_defense_area() const;
  public:
  void clear_attacker_in_defense_area();
  const ::GameEvent_AttackerInDefenseArea& attacker_in_defense_area() const;
  ::GameEvent_AttackerInDefenseArea* release_attacker_in_defense_area();
  ::GameEvent_AttackerInDefenseArea* mutable_attacker_in_defense_area();
  void set_allocated_attacker_in_defense_area(::GameEvent_AttackerInDefenseArea* attacker_in_defense_area);
  private:
  const ::GameEvent_AttackerInDefenseArea& _internal_attacker_in_defense_area() const;
  ::GameEvent_AttackerInDefenseArea* _internal_mutable_attacker_in_defense_area();
  public:
  void unsafe_arena_set_allocated_attacker_in_defense_area(
      ::GameEvent_AttackerInDefenseArea* attacker_in_defense_area);
  ::GameEvent_AttackerInDefenseArea* unsafe_arena_release_attacker_in_defense_area();

  // .GameEvent.AttackerTouchedKeeper attacker_touched_keeper = 16;
  bool has_attacker_touched_keeper() const;
  private:
  bool _internal_has_attacker_touched_keeper() const;
  public:
  void clear_attacker_touched_keeper();
  const ::GameEvent_AttackerTouchedKeeper& attacker_touched_keeper() const;
  ::GameEvent_AttackerTouchedKeeper* release_attacker_touched_keeper();
  ::GameEvent_AttackerTouchedKeeper* mutable_attacker_touched_keeper();
  void set_allocated_attacker_touched_keeper(::GameEvent_AttackerTouchedKeeper* attacker_touched_keeper);
  private:
  const ::GameEvent_AttackerTouchedKeeper& _internal_attacker_touched_keeper() const;
  ::GameEvent_AttackerTouchedKeeper* _internal_mutable_attacker_touched_keeper();
  public:
  void unsafe_arena_set_allocated_attacker_touched_keeper(
      ::GameEvent_AttackerTouchedKeeper* attacker_touched_keeper);
  ::GameEvent_AttackerTouchedKeeper* unsafe_arena_release_attacker_touched_keeper();
 ...
 private:
  ...
  void set_has_attacker_in_defense_area();
  void set_has_attacker_touched_keeper();
  ...
  union EventUnion {
    ...
    ::GameEvent_AttackerInDefenseArea* attacker_in_defense_area_;
    ::GameEvent_AttackerTouchedKeeper* attacker_touched_keeper_;
...
// required .Team by_team = 1;
inline bool GameEvent_AttackerInDefenseArea::_internal_has_by_team() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool GameEvent_AttackerInDefenseArea::has_by_team() const {
  return _internal_has_by_team();
}
inline void GameEvent_AttackerInDefenseArea::clear_by_team() {
  by_team_ = 0;
  _has_bits_[0] &= ~0x00000002u;
}
inline ::Team GameEvent_AttackerInDefenseArea::_internal_by_team() const {
  return static_cast< ::Team >(by_team_);
}
inline ::Team GameEvent_AttackerInDefenseArea::by_team() const {
  // @@protoc_insertion_point(field_get:GameEvent.AttackerInDefenseArea.by_team)
  return _internal_by_team();
}
inline void GameEvent_AttackerInDefenseArea::_internal_set_by_team(::Team value) {
  assert(::Team_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  by_team_ = value;
}
inline void GameEvent_AttackerInDefenseArea::set_by_team(::Team value) {
  _internal_set_by_team(value);
  // @@protoc_insertion_point(field_set:GameEvent.AttackerInDefenseArea.by_team)
}

// optional uint32 by_bot = 2;
inline bool GameEvent_AttackerInDefenseArea::_internal_has_by_bot() const {
  bool value = (_has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool GameEvent_AttackerInDefenseArea::has_by_bot() const {
  return _internal_has_by_bot();
}
inline void GameEvent_AttackerInDefenseArea::clear_by_bot() {
  by_bot_ = 0u;
  _has_bits_[0] &= ~0x00000004u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GameEvent_AttackerInDefenseArea::_internal_by_bot() const {
  return by_bot_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GameEvent_AttackerInDefenseArea::by_bot() const {
  // @@protoc_insertion_point(field_get:GameEvent.AttackerInDefenseArea.by_bot)
  return _internal_by_bot();
}
inline void GameEvent_AttackerInDefenseArea::_internal_set_by_bot(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000004u;
  by_bot_ = value;
}
inline void GameEvent_AttackerInDefenseArea::set_by_bot(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_by_bot(value);
  // @@protoc_insertion_point(field_set:GameEvent.AttackerInDefenseArea.by_bot)
}

// optional .Location location = 3;
inline bool GameEvent_AttackerInDefenseArea::_internal_has_location() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || location_ != nullptr);
  return value;
}
inline bool GameEvent_AttackerInDefenseArea::has_location() const {
  return _internal_has_location();
}
inline const ::Location& GameEvent_AttackerInDefenseArea::_internal_location() const {
  const ::Location* p = location_;
  return p != nullptr ? *p : *reinterpret_cast<const ::Location*>(
      &::_Location_default_instance_);
}
inline const ::Location& GameEvent_AttackerInDefenseArea::location() const {
  // @@protoc_insertion_point(field_get:GameEvent.AttackerInDefenseArea.location)
  return _internal_location();
}
inline void GameEvent_AttackerInDefenseArea::unsafe_arena_set_allocated_location(
    ::Location* location) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(location_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:GameEvent.AttackerInDefenseArea.location)
}
inline ::Location* GameEvent_AttackerInDefenseArea::release_location() {
  auto temp = unsafe_arena_release_location();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
...
inline ::Location* GameEvent_AttackerInDefenseArea::unsafe_arena_release_location() {
  // @@protoc_insertion_point(field_release:GameEvent.AttackerInDefenseArea.location)
  _has_bits_[0] &= ~0x00000001u;
  ::Location* temp = location_;
  location_ = nullptr;
  return temp;
}
inline ::Location* GameEvent_AttackerInDefenseArea::_internal_mutable_location() {
  _has_bits_[0] |= 0x00000001u;
  if (location_ == nullptr) {
    auto* p = CreateMaybeMessage<::Location>(GetArena());
    location_ = p;
...
inline ::Location* GameEvent_AttackerInDefenseArea::mutable_location() {
  // @@protoc_insertion_point(field_mutable:GameEvent.AttackerInDefenseArea.location)
  return _internal_mutable_location();
}
inline void GameEvent_AttackerInDefenseArea::set_allocated_location(::Location* location) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(location_);
  }
  ...
  location_ = location;
  // @@protoc_insertion_point(field_set_allocated:GameEvent.AttackerInDefenseArea.location)
}

// optional float distance = 4;
inline bool GameEvent_AttackerInDefenseArea::_internal_has_distance() const {
  bool value = (_has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool GameEvent_AttackerInDefenseArea::has_distance() const {
  return _internal_has_distance();
}
inline void GameEvent_AttackerInDefenseArea::clear_distance() {
  distance_ = 0;
  _has_bits_[0] &= ~0x00000008u;
}
inline float GameEvent_AttackerInDefenseArea::_internal_distance() const {
  return distance_;
}
inline float GameEvent_AttackerInDefenseArea::distance() const {
  // @@protoc_insertion_point(field_get:GameEvent.AttackerInDefenseArea.distance)
  return _internal_distance();
}
inline void GameEvent_AttackerInDefenseArea::_internal_set_distance(float value) {
  _has_bits_[0] |= 0x00000008u;
  distance_ = value;
}
inline void GameEvent_AttackerInDefenseArea::set_distance(float value) {
  _internal_set_distance(value);
  // @@protoc_insertion_point(field_set:GameEvent.AttackerInDefenseArea.distance)
}
...
// required .Team by_team = 1;
inline bool GameEvent_AttackerTouchedKeeper::_internal_has_by_team() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool GameEvent_AttackerTouchedKeeper::has_by_team() const {
  return _internal_has_by_team();
}
inline void GameEvent_AttackerTouchedKeeper::clear_by_team() {
  by_team_ = 0;
  _has_bits_[0] &= ~0x00000002u;
}
inline ::Team GameEvent_AttackerTouchedKeeper::_internal_by_team() const {
  return static_cast< ::Team >(by_team_);
}
inline ::Team GameEvent_AttackerTouchedKeeper::by_team() const {
  // @@protoc_insertion_point(field_get:GameEvent.AttackerTouchedKeeper.by_team)
  return _internal_by_team();
}
inline void GameEvent_AttackerTouchedKeeper::_internal_set_by_team(::Team value) {
  assert(::Team_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  by_team_ = value;
}
inline void GameEvent_AttackerTouchedKeeper::set_by_team(::Team value) {
  _internal_set_by_team(value);
  // @@protoc_insertion_point(field_set:GameEvent.AttackerTouchedKeeper.by_team)
}

// optional uint32 by_bot = 2;
inline bool GameEvent_AttackerTouchedKeeper::_internal_has_by_bot() const {
  bool value = (_has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool GameEvent_AttackerTouchedKeeper::has_by_bot() const {
  return _internal_has_by_bot();
}
inline void GameEvent_AttackerTouchedKeeper::clear_by_bot() {
  by_bot_ = 0u;
  _has_bits_[0] &= ~0x00000004u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GameEvent_AttackerTouchedKeeper::_internal_by_bot() const {
  return by_bot_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GameEvent_AttackerTouchedKeeper::by_bot() const {
  // @@protoc_insertion_point(field_get:GameEvent.AttackerTouchedKeeper.by_bot)
  return _internal_by_bot();
}
inline void GameEvent_AttackerTouchedKeeper::_internal_set_by_bot(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000004u;
  by_bot_ = value;
}
inline void GameEvent_AttackerTouchedKeeper::set_by_bot(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_by_bot(value);
  // @@protoc_insertion_point(field_set:GameEvent.AttackerTouchedKeeper.by_bot)
}

// optional .Location location = 3;
inline bool GameEvent_AttackerTouchedKeeper::_internal_has_location() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || location_ != nullptr);
  return value;
}
inline bool GameEvent_AttackerTouchedKeeper::has_location() const {
  return _internal_has_location();
}
inline const ::Location& GameEvent_AttackerTouchedKeeper::_internal_location() const {
  const ::Location* p = location_;
  return p != nullptr ? *p : *reinterpret_cast<const ::Location*>(
      &::_Location_default_instance_);
}
inline const ::Location& GameEvent_AttackerTouchedKeeper::location() const {
  // @@protoc_insertion_point(field_get:GameEvent.AttackerTouchedKeeper.location)
  return _internal_location();
}
inline void GameEvent_AttackerTouchedKeeper::unsafe_arena_set_allocated_location(
    ::Location* location) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(location_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:GameEvent.AttackerTouchedKeeper.location)
}
inline ::Location* GameEvent_AttackerTouchedKeeper::release_location() {
  auto temp = unsafe_arena_release_location();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
...
inline ::Location* GameEvent_AttackerTouchedKeeper::unsafe_arena_release_location() {
  // @@protoc_insertion_point(field_release:GameEvent.AttackerTouchedKeeper.location)
  _has_bits_[0] &= ~0x00000001u;
  ::Location* temp = location_;
  location_ = nullptr;
  return temp;
}
inline ::Location* GameEvent_AttackerTouchedKeeper::_internal_mutable_location() {
  _has_bits_[0] |= 0x00000001u;
  if (location_ == nullptr) {
    auto* p = CreateMaybeMessage<::Location>(GetArena());
    location_ = p;
...
inline ::Location* GameEvent_AttackerTouchedKeeper::mutable_location() {
  // @@protoc_insertion_point(field_mutable:GameEvent.AttackerTouchedKeeper.location)
  return _internal_mutable_location();
}
inline void GameEvent_AttackerTouchedKeeper::set_allocated_location(::Location* location) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(location_);
  }
  ...
  location_ = location;
  // @@protoc_insertion_point(field_set_allocated:GameEvent.AttackerTouchedKeeper.location)
}
...
// .GameEvent.AttackerInDefenseArea attacker_in_defense_area = 15;
inline bool GameEvent::_internal_has_attacker_in_defense_area() const {
  return event_case() == kAttackerInDefenseArea;
}
inline bool GameEvent::has_attacker_in_defense_area() const {
  return _internal_has_attacker_in_defense_area();
}
inline void GameEvent::set_has_attacker_in_defense_area() {
  _oneof_case_[0] = kAttackerInDefenseArea;
}
inline void GameEvent::clear_attacker_in_defense_area() {
  if (_internal_has_attacker_in_defense_area()) {
    if (GetArena() == nullptr) {
...
inline ::GameEvent_AttackerInDefenseArea* GameEvent::release_attacker_in_defense_area() {
  // @@protoc_insertion_point(field_release:GameEvent.attacker_in_defense_area)
  if (_internal_has_attacker_in_defense_area()) {
    clear_has_event();
      ::GameEvent_AttackerInDefenseArea* temp = event_.attacker_in_defense_area_;
    if (GetArena() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    event_.attacker_in_defense_area_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::GameEvent_AttackerInDefenseArea& GameEvent::_internal_attacker_in_defense_area() const {
  return _internal_has_attacker_in_defense_area()
      ? *event_.attacker_in_defense_area_
      : *reinterpret_cast< ::GameEvent_AttackerInDefenseArea*>(&::_GameEvent_AttackerInDefenseArea_default_instance_);
}
inline const ::GameEvent_AttackerInDefenseArea& GameEvent::attacker_in_defense_area() const {
  // @@protoc_insertion_point(field_get:GameEvent.attacker_in_defense_area)
  return _internal_attacker_in_defense_area();
}
inline ::GameEvent_AttackerInDefenseArea* GameEvent::unsafe_arena_release_attacker_in_defense_area() {
  // @@protoc_insertion_point(field_unsafe_arena_release:GameEvent.attacker_in_defense_area)
  if (_internal_has_attacker_in_defense_area()) {
    clear_has_event();
    ::GameEvent_AttackerInDefenseArea* temp = event_.attacker_in_defense_area_;
    event_.attacker_in_defense_area_ = nullptr;
...
inline void GameEvent::unsafe_arena_set_allocated_attacker_in_defense_area(::GameEvent_AttackerInDefenseArea* attacker_in_defense_area) {
  clear_event();
  if (attacker_in_defense_area) {
    set_has_attacker_in_defense_area();
    event_.attacker_in_defense_area_ = attacker_in_defense_area;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:GameEvent.attacker_in_defense_area)
}
inline ::GameEvent_AttackerInDefenseArea* GameEvent::_internal_mutable_attacker_in_defense_area() {
  if (!_internal_has_attacker_in_defense_area()) {
    clear_event();
    set_has_attacker_in_defense_area();
    event_.attacker_in_defense_area_ = CreateMaybeMessage< ::GameEvent_AttackerInDefenseArea >(GetArena());
  }
  return event_.attacker_in_defense_area_;
}
inline ::GameEvent_AttackerInDefenseArea* GameEvent::mutable_attacker_in_defense_area() {
  // @@protoc_insertion_point(field_mutable:GameEvent.attacker_in_defense_area)
  return _internal_mutable_attacker_in_defense_area();
}

// .GameEvent.AttackerTouchedKeeper attacker_touched_keeper = 16;
inline bool GameEvent::_internal_has_attacker_touched_keeper() const {
  return event_case() == kAttackerTouchedKeeper;
}
inline bool GameEvent::has_attacker_touched_keeper() const {
  return _internal_has_attacker_touched_keeper();
}
inline void GameEvent::set_has_attacker_touched_keeper() {
  _oneof_case_[0] = kAttackerTouchedKeeper;
}
inline void GameEvent::clear_attacker_touched_keeper() {
  if (_internal_has_attacker_touched_keeper()) {
    if (GetArena() == nullptr) {
...
inline ::GameEvent_AttackerTouchedKeeper* GameEvent::release_attacker_touched_keeper() {
  // @@protoc_insertion_point(field_release:GameEvent.attacker_touched_keeper)
  if (_internal_has_attacker_touched_keeper()) {
    clear_has_event();
      ::GameEvent_AttackerTouchedKeeper* temp = event_.attacker_touched_keeper_;
    if (GetArena() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    event_.attacker_touched_keeper_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::GameEvent_AttackerTouchedKeeper& GameEvent::_internal_attacker_touched_keeper() const {
  return _internal_has_attacker_touched_keeper()
      ? *event_.attacker_touched_keeper_
      : *reinterpret_cast< ::GameEvent_AttackerTouchedKeeper*>(&::_GameEvent_AttackerTouchedKeeper_default_instance_);
}
inline const ::GameEvent_AttackerTouchedKeeper& GameEvent::attacker_touched_keeper() const {
  // @@protoc_insertion_point(field_get:GameEvent.attacker_touched_keeper)
  return _internal_attacker_touched_keeper();
}
inline ::GameEvent_AttackerTouchedKeeper* GameEvent::unsafe_arena_release_attacker_touched_keeper() {
  // @@protoc_insertion_point(field_unsafe_arena_release:GameEvent.attacker_touched_keeper)
  if (_internal_has_attacker_touched_keeper()) {
    clear_has_event();
    ::GameEvent_AttackerTouchedKeeper* temp = event_.attacker_touched_keeper_;
    event_.attacker_touched_keeper_ = nullptr;
...
inline void GameEvent::unsafe_arena_set_allocated_attacker_touched_keeper(::GameEvent_AttackerTouchedKeeper* attacker_touched_keeper) {
  clear_event();
  if (attacker_touched_keeper) {
    set_has_attacker_touched_keeper();
    event_.attacker_touched_keeper_ = attacker_touched_keeper;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:GameEvent.attacker_touched_keeper)
}
inline ::GameEvent_AttackerTouchedKeeper* GameEvent::_internal_mutable_attacker_touched_keeper() {
  if (!_internal_has_attacker_touched_keeper()) {
    clear_event();
    set_has_attacker_touched_keeper();
    event_.attacker_touched_keeper_ = CreateMaybeMessage< ::GameEvent_AttackerTouchedKeeper >(GetArena());
  }
  return event_.attacker_touched_keeper_;
}
inline ::GameEvent_AttackerTouchedKeeper* GameEvent::mutable_attacker_touched_keeper() {
  // @@protoc_insertion_point(field_mutable:GameEvent.attacker_touched_keeper)
  return _internal_mutable_attacker_touched_keeper();
}
